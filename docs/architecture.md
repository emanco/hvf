...
3. `score_pattern()` — 6 components: tightness(25), volume(20), ATR(20), RRR(20), MTF(10), session(5)
...
- Convergence: wave1_range > 1.5 × wave3_range
- Prior trend: h1 above EMA200 (bullish), l1 below (bearish)
...
- Volume contraction (0-20 pts)
- 4H trend confirmation (0/5/10 pts)
- Session quality (0-5 pts)
