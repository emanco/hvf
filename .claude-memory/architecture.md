...
hvf_trader/
    ...
    main.py                       # 4-thread orchestrator: scanner + monitor + health + telegram commands
    requirements.txt
    ...
    alerts/
        telegram_bot.py           # Trade alerts + daily summary + equity chart + errors
        telegram_commands.py      # Interactive commands via polling (/status /health /trades /equity /balance)
